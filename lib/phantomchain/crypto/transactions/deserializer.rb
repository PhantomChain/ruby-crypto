    ...
    module Transactions
      ...
      class Deserializer
        ...
        def handle_type(asset_offset, transaction)
          ...
          deserializer = Object.const_get("PhantomChain::Crypto::Transactions::Deserializers::#{deserializer}")
        ...
        def handle_version_one(transaction)
          ...
          if transaction.type == PhantomChain::Crypto::Enums::Types::VOTE
            transaction.recipient_id = PhantomChain::Crypto::Identities::Address.from_public_key(transaction.sender_public_key, transaction.network)
          end

          if transaction.type == PhantomChain::Crypto::Enums::Types::MULTI_SIGNATURE_REGISTRATION
          ...
          if transaction.type == PhantomChain::Crypto::Enums::Types::SECOND_SIGNATURE_REGISTRATION
            transaction.recipient_id = PhantomChain::Crypto::Identities::Address.from_public_key(transaction.sender_public_key, transaction.network)
          end
