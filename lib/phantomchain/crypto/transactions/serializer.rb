    ...
    module Transactions
      ...
      class Serializer
        ...
        def serialize
          ...
          bytes << [@transaction[:network] || PhantomChain::Crypto::Configuration::Network.get.version].pack('C')
        ...
        def handle_type(bytes)
          ...
          serializer = Object.const_get("PhantomChain::Crypto::Transactions::Serializers::#{serializer}")
